          ...
          <div className="text-sm">
            <div className="flex items-center gap-x-1 p-2">
              ...
              <Input
                ...
                className="bg-secondary h-7 px-2"
                placeholder="Filter by resume title"
                aria-label="Filter by resume title"
              />
            </div>
            <div className="mt-2 px-1 pb-1">
              <p className="text-muted-foreground hidden text-center text-xs last:block">No documents found</p>
              ...
              {filteredDocuments?.map((doc: DocumentType) => (
                <div
                  ...
                  className="hover:bg-primary/5 flex w-full items-center justify-between rounded-s px-1 py-1 text-sm"
                >
