            ...
            <div key={item.id || index}>
              <div className="relative mb-5 grid grid-cols-2 gap-3 pt-4">
                ...
                <div className="col-span-2">
                  ...
                  <Input
                    aria-label={item?.educationType === 'course' ? t('Institution Name') : t('University Name')}
                    name="universityName"
                    placeholder=""
                    required
                ...
                <div>
                  ...
                  <Input
                    aria-label={item?.educationType === 'course' ? t('Course Name') : t('Degree')}
                    name="degree"
                    placeholder=""
                    required
                    value={item?.degree || ''}
                ...
                <div className="col-span-2 flex items-center gap-6">
                  <div className="flex items-center">
                    ...
                    />
                    <Label htmlFor={`hide-dates-checkbox-${index}`} className="ml-2 cursor-pointer text-xs select-none">
                      {t('Hide Dates')}
                    </Label>
                  </div>
                  <div className="flex items-center">
                    ...
                    />
                    <Label htmlFor={`years-only-checkbox-${index}`} className="ml-2 cursor-pointer text-xs select-none">
                      {t('Years only')}
                    </Label>
                  </div>
                </div>
