    ...
    <div>
      <div className="mb-2 flex items-center gap-2">
        {localLanguages.length > 1 && (
          <div className="text-muted-foreground text-sm">{t('Use arrows to reorder languages')}</div>
        )}
      </div>
      <div className="mb-2 flex w-full items-center gap-2">
        <Input
          aria-label={t('Language section title')}
              ...
              <div className="relative mb-5 grid grid-cols-2 gap-3 pt-4">
                {localLanguages.length > 1 && (
                  <div className="absolute top-4 -left-8 flex flex-col gap-1">
                    ...
                    <Button
                      aria-label={t('Move language down')}
                      variant="ghost"
                      size="icon"
                      type="button"
                      className="size-6"
