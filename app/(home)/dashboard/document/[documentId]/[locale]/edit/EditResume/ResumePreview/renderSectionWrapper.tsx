  ...
  return (
    <div
      ...
      className={cn(
        ...
        isSelected && 'ring-opacity-50 bg-blue-50 p-2 ring-2 ring-blue-500 dark:bg-blue-950 dark:ring-blue-400'
      )}
      onClick={e => {
        e.stopPropagation();
    ...
    >
      ...
      {isSelected && (
        <div
          ...
          className="absolute top-2 right-2 z-[60] flex flex-col gap-1 rounded-md border bg-white p-1 shadow-lg dark:border-gray-600 dark:bg-gray-800"
        >
          <Button
            variant="ghost"
            size="icon"
            ...
            aria-label={translations?.moveSectionUp || 'Move section up'}
          >
            <MoveUp size={14} />
          </Button>
          <Button
            ...
            aria-label={translations?.moveSectionDown || 'Move section down'}
          >
            <MoveDown size={14} />
          </Button>
        </div>
