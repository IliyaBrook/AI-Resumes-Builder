  ...
  return (
    <div className="mt-4">
      {sortedCategoryKeys.length > 1 && (
        <div className="text-muted-foreground mb-2 text-sm">{t('Use arrows to reorder categories')}</div>
      )}
          ...
          return (
            <div key={categoryName} className="rounded-md border p-3">
              <div className="relative mb-2 flex items-center gap-2">
                {sortedCategoryKeys.length > 1 && (
                  <div className="absolute top-0 -left-8 flex flex-col gap-1">
                    <Button
                      variant="ghost"
                      size="icon"
                      type="button"
                    ...
                    <Button
                      ...
                      aria-label={t('Move category down')}
                    >
                      <MoveDown size={14} />
                    </Button>
                  </div>
                ...
                {editingCategory === categoryName ? (
                  ...
                  <>
                    ...
                    <Button
                      ...
                      aria-label={t('Delete category and all skills')}
                    >
                      <X size="15px" />
                    </Button>
                  </>
